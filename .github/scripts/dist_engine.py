...
if __name__ == "__main__":
    ...
    "laptops-computers": ["laptops", "reviews", "computers"],
    "home-office-gear": ["productivity", "reviews", "workspace"],
    "gaming-gear": ["gaming", "reviews", "peripherals"],
    "ereaders-tablets": ["books", "reviews", "tablet"],
    "wearables-fitness": ["fitness", "reviews", "wearables"],
    "portable-audio": ["audio", "reviews", "music"],
    "home-audio": ["audio", "reviews", "hifi"],
    "smart-home-devices": ["iot", "reviews", "smarthome"],
    "smart-home-security": ["security", "reviews", "smarthome"],
    "smart-kitchen": ["cooking", "reviews", "kitchen"],
    "kitchen-appliances": ["cooking", "reviews", "appliances"],
    "smart-pet-gear": ["pets", "reviews", "gadgets"],
    "charging-accessories": ["tech", "reviews", "accessories"],
    "car-tech": ["automotive", "reviews", "gadgets"],
    "photography-video": ["photography", "reviews", "cameras"],
    "drones": ["drones", "reviews", "photography"],
    "home-cleaning": ["home", "reviews", "cleaning"],
    "networking": ["networking", "reviews", "wifi"],
    "outdoor-tech": ["outdoors", "reviews", "camping"],
    "health-wellness": ["health", "reviews", "wellness"],
    "monitors-displays": ["monitors", "reviews", "displays"],
}!/usr/bin/env python3
"""
Distribution Engine v3 — Multi-channel syndication.
Runs after seo_engine.py.
